...
function opstr = genOmniposeCommand(dirname_xy)
    ...
    opstr = ['python -m omnipose --dir ' diralign ' --save_png --dir_above --no_npy --in_folders  --omni --pretrained_model bact_fluor_omni --cluster --mask_threshold 1 --flow_threshold 0 --diameter 30'];
