function pipeline( dirname ,align, autoomni, log_flag)
...
CONST = loadConstants_pipeline(res,parallel_flag,align1) ;

% https://github.com/tlo-bot/supersegger-omnipose/commit/1493af3972d384e86ed09d2f4606bc96b1e1e258
...
pipelineSeg( dirname, skip, cleanflag, CONST, [], [], autoomni);
